...
function Login() {
    ...
    const signIn = event => {
        ...
        auth
            ...
            .then(auth => {
                    if(user == ''){
                        alert('Choose who you are - client/clinician')
                    }
                    else{
                        if (user=='clinician'){
                            console.log("here", user)
                            history.push('/clinicianHome')
            ...
            // axios.post('http://localhost:3000/login', credentials, {headers: {
                ...
                if (auth){
                    if(user == ''){
                        ...
                        if(user=='clinician'){
                            ...
                            alert('Only a clinician can create an account!')
                        }
                    }
